/*	
    Archivo:		lab05_post_pgr.s
    Dispositivo:	PIC16F887
    Autor:		Gerardo Paz 20173
    Compilador:		pic-as (v2.30), MPLABX V6.00

    Programa:		Displays simultáneos y cotadores
...
CONFIG  WRT = OFF             ; Flash Program Memory Self Write Enable bits (Write protection off)
 ...
 int_iocb:	
    ...
    CLRF    RESULTADO
    CALL    dividir	//División centenas, decenas, unidades
    
    BCF	    RBIF	//Limpiar bandera
    RETURN
    
 dividir:
    INCF    CENTENAS	    //Empezar en 1
    MOVF    CONT, W	
    SUBLW   100		    //100-w
    ADDWF   RESULTADO
    BTFSC   STATUS, 0	    //Skip if Carry = 1
    GOTO    $-4
    
    DECF    CENTENAS	    //Quitar el 1 extra
    INCF    DECENAS
    MOVF    CONT, W	
    SUBLW   10		    //10-w
    BTFSC   STATUS, 0	    //Skip if Carry = 1
    ...
    DECF    DECENAS	    //Quitar el 1 extra
    INCF    UNIDADES
    MOVF    CONT, W	
    SUBLW   1		    //1-w
    BTFSS   ZERO	    //Skip if zero = 1
    GOTO    $-4
